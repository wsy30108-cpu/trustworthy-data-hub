...
const initialConfigs: Record<string, TaskPreannotationConfig> = {
  ...
  "BT-AL-01": {
    ...
    failed: 0,
    status: "执行中",
    dispatchedAt: "2026-05-01 08:30",
    estimatedFinishAt: "2026-05-01 12:00",
    trainingReplicaName: "情感-AL-训练副本-A",
  },
  "BT-AL-02": {
    taskId: "BT-AL-02",
    batchEnabled: true,
    ...
    failed: 0,
    status: "执行中",
    dispatchedAt: "2026-05-02 09:00",
    estimatedFinishAt: "2026-05-02 13:30",
    trainingReplicaName: "情感-AL-训练副本-A",
  },
  "BT-AL-03": {
    taskId: "BT-AL-03",
    ...
    failed: 0,
    status: "已完成",
    dispatchedAt: "2026-05-08 08:00",
    estimatedFinishAt: "2026-05-08 11:00",
    finishedAt: "2026-05-08 10:42",
    trainingReplicaName: "道路-AL-训练副本",
  },
  "BT-AL-04": {
    taskId: "BT-AL-04",
    batchEnabled: true,
    ...
    failed: 0,
    status: "已完成",
    dispatchedAt: "2026-05-09 08:30",
    estimatedFinishAt: "2026-05-09 12:00",
    finishedAt: "2026-05-09 11:50",
    trainingReplicaName: "道路-AL-训练副本",
  },
};
